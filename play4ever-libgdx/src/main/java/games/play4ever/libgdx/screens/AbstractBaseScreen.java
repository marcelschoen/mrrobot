...
public abstract class AbstractBaseScreen implements Screen {
	 ...
	 * @param game
	 */
	public AbstractBaseScreen(Game game, Color backgroundColor) {
		initialize(game, backgroundColor);
	}
	 ...
	 * @param game
	 */
	public AbstractBaseScreen(Game game) {
		initialize(game, Color.BLACK);
	}

	private void initialize(Game game, Color backgroundColor) {
		this.game = game;
	...
	/**
	 * Should perform the actual screen rendering.
	 *
	 * @param delta
	 */
