...
public abstract class AbstractBaseController implements IController {
	...
	/* (non-Javadoc)
	 * @see com.jplay.gdx.joypad.IController#getDpadDirectionOnce()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.jplay.gdx.joypad.IController#isButtonPressedOnce(com.jplay.gdx.joypad.ButtonID)
	 */
	@Override
...
//		return getButton(buttonID).isPressedOnce();
	...
	/* (non-Javadoc)
	 * @see com.jplay.gdx.joypad.IController#getButtons()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.jplay.gdx.joypad.IController#getButton(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.jplay.gdx.joypad.IController#getButton(com.jplay.gdx.joypad.ButtonID)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.jplay.gdx.joypad.IController#isButtonPressed(com.jplay.gdx.joypad.ButtonID)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.jplay.gdx.joypad.IController#getAnalogButtonPressure(com.jplay.gdx.joypad.ButtonID)
	 */
	@Override
