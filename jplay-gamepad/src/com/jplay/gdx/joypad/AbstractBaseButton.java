...
public abstract class AbstractBaseButton implements IButton {
	...
	/* (non-Javadoc)
	 * @see com.jplay.gdx.joypad.IButton#getID()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.jplay.gdx.joypad.AbstractBaseButton#getCode()
	 */
	@Override
	public int getCode() {
		return this.code;
	...
	/* (non-Javadoc)
	 * @see com.jplay.gdx.joypad.IButton#isAnalogue()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.jplay.gdx.joypad.IButton#isPressedOnce()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.jplay.gdx.joypad.IButton#getLabelKey()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.jplay.gdx.joypad.IButton#getDefaultLabel()
	 */
	@Override
