package games.play4ever.libgdx.aseprite;
...
public final class Aseprite {
     ...
     */
    public static HashMap<String, Animation<TextureRegion>> fromFile(String key, FileHandle jsonFile, FileHandle pngFile) {
